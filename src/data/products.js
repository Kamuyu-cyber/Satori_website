const products = [
    {
        id: 24,
        name: 'Tchala Full Set',
        price: 'KES 8,000',
        image: '/images/Tchala.jpeg',
        tag: 'Bundle',
        collection: 'Tchala',
        soldOut: false,
        description:
            'The complete Tchala silhouette. This bundle includes both the structural jacket and coordinating trousers, offering a cohesive and powerful aesthetic that defines the Satori vision.',
        details: [
            'Includes Tchala Jacket + Trousers',
            'Coordinated editorial aesthetic',
    ...
    },
    {
        ...
        soldOut: false,
        description:
            'Complementing the Tchala Jacket, these trousers offer a refined fit and exceptional drape. Designed with precision to anchor the Tchala silhouette, they transition effortlessly from day to night.',
        details: [
            'Tailored architectural silhouette',
            'Premium heavyweight fabric',
            'Functional four-pocket design',
    ...
    },
    {
        ...
        soldOut: false,
        description:
            'The Tchala Jacket is a masterclass in contemporary structure. Crafted from premium materials with a focus on silhouette and movement, it serves as a foundational piece for the modern editorial wardrobe.',
        details: [
            'Premium structural fabric',
            'Contemporary oversized fit',
            'Reinforced seams',
            'Internal utilitarian pockets',
    ...
    },
    {
        ...
        name: 'Moron Black',
        price: 'KES 2,600',
        image: '/images/Moron Black.jpeg',
        tag: 'Collection',
        collection: 'Bags',
        soldOut: false,
        description:
            'A compact essential from our bag collection. The Moron Black is a versatile accessory designed for the minimalist on the move, featuring durable construction and a sleek, timeless finish.',
        details: [
            'Durable canvas construction',
            'Minimalist black-on-black aesthetic',
    ...
    },
    {
        ...
        name: 'Maji',
        price: 'KES 20,500',
        image: '/images/Maji.jpeg',
        tag: 'Collection',
        collection: 'Bags',
        soldOut: false,
        description:
            'The Maji Bag blends fluid lines with structured utility. Inspired by the movement of water, this piece offers a sophisticated silhouette that complements both formal and casual ensembles.',
        details: [
            'Fluid architectural silhouette',
    ...
    },
    {
        ...
        name: 'I Mali Bag',
        price: 'KES 32,500',
        image: '/images/I Mali Bag.jpeg',
        tag: 'Collection',
        collection: 'Bags',
        soldOut: false,
        description:
            "A masterpiece of functional art, the I Mali Bag represents the pinnacle of Satori's bag collection. Handcrafted with premium materials and signature detailing, it's designed for those who carry their world with elegance.",
        details: [
            'Premium handcrafted leather',
            'Signature Satori hardware',
